...
public partial class AddSceneTexturePopupWindow : Popup
{
    public AddSceneTexturePopupWindowViewModel ViewModel => m_viewModel;

    public AddSceneTexturePopupWindow(AddSceneTexturePopupWindowViewModel viewModel)
    {
        InitializeComponent();
    ...
    private readonly AddSceneTexturePopupWindowViewModel m_viewModel;
}
