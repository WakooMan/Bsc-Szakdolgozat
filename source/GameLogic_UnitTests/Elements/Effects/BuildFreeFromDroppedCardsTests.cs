...
namespace GameLogic_UnitTests.Elements.Effects
{
    public class BuildFreeFromDroppedCardsTests
    {
        ...
        public void When_Apply_Called_And_DroppedCardList_Is_Null()
        {
            ...
            playerActionReceiver.ReceivePlayerAction(player, Arg.Any<ICollection<ChooseCardAction>>()).Returns(playerAction);
            ...
            playerActionReceiver.DidNotReceive().ReceivePlayerAction(player, Arg.Any<ICollection<ChooseCardAction>>());
        ...
        public void When_Apply_Called()
        {
            ...
            playerActionReceiver.Received(1).ReceivePlayerAction(player, Arg.Any<ICollection<ChooseCardAction>>());
