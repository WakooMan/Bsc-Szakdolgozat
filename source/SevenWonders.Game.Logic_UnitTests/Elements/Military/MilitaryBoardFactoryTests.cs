...
namespace GameLogic_UnitTests.Elements.Military
{
    public class MilitaryBoardFactoryTests
    {
        ...
        public void Setup()
        {
            ...
            m_xmlHandler.DeserializeEmbeddedResource<MilitaryBoard>(Arg.Any<string>()).Returns(m_militaryBoard);
        ...
        public void When_Create_Called()
        {
            ...
            m_xmlHandler.Received(1).DeserializeEmbeddedResource<MilitaryBoard>(Arg.Any<string>());
        }
