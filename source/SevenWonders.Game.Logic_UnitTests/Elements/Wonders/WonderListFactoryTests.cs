...
namespace GameLogic_UnitTests.Elements.Wonders
{
    public class WonderListFactoryTests
    {
        ...
        public void Setup()
        {
            ...
            m_xmlHandler.DeserializeEmbeddedResource<WonderList>(Arg.Any<string>()).Returns(m_wonderList);
        ...
        public void When_Create_Called()
        {
            ...
            m_xmlHandler.Received(1).DeserializeEmbeddedResource<WonderList>(Arg.Any<string>());
        }
