...
namespace GameLogic_UnitTests.GameStructures
{
    public class CardCompositionTests
    {
        ...
        public void Setup()
        {
            ...
            m_cardComposition = new CardComposition(m_cardCompositionFileHandler, m_cardNodeFactory, m_eventManager, m_cards);
        }

        [Test]
        public void When_Constructor_Called_With_Null()
        {
            Assert.Throws<ArgumentNullException>(() => new CardComposition(null, m_cardNodeFactory, m_eventManager, m_cards));
            Assert.Throws<ArgumentNullException>(() => new CardComposition(m_cardCompositionFileHandler, null, m_eventManager, m_cards));
            Assert.Throws<ArgumentNullException>(() => new CardComposition(m_cardCompositionFileHandler, m_cardNodeFactory, null, m_cards));
            Assert.Throws<ArgumentNullException>(() => new CardComposition(m_cardCompositionFileHandler, m_cardNodeFactory, m_eventManager, null));
        }
        ...
        public void When_Constructor_Called_With_Empty_List()
        {
            ...
            Assert.Throws<ArgumentException>(() => new CardComposition(m_cardCompositionFileHandler, m_cardNodeFactory, m_eventManager, cards));
        }
