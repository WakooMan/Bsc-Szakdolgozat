...
namespace GameLogic.Elements.Effects
{
    public class ChooseDevelopment : Effect
    {
        ...
        public override async Task Apply(IGameContext gameContext)
        {
            ...
            await gameContext.EventManager.PublishAsync(new OnChooseDevelopmentsBegin(developments, true));
            ...
            await gameContext.EventManager.PublishAsync(new OnChooseDevelopmentsEnd(developments, true));
        }
    }
}
